//Jeremiah Hsieh ICSI 500 Lab 10 Client
//sends data to the server at specified address and port


//sends service type required and file data (filename or actual text?)
...
int main(int argc, char *argv[])
{
    ...
    //check if argv is host name string or number int?
